...
/**
 * Settings panel for the administration page
 */
class Settings implements ISettings {
	 ...
	 */
	public function __construct(AppConfig $config, IURLGenerator $urlGenerator) {
		$this->config = $config;
	...
	public function getPanel() {
		...
		return new TemplateResponse("onlyoffice", "settings", $data, "blank");
	}
