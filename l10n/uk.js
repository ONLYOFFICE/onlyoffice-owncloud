OC.L10N.register(
    ...
    "Encryption App is enabled, the application cannot work. You can continue working with the application if you enable master key.": "Програму шифрування ввімкнено, але вона не може працювати. Ви можете продовжити роботу з програмою, якщо ввімкнете головний ключ.",
    ...
    "Light": "Світла",
    "Dark": "Темна",
    "This feature is unavailable due to encryption settings.": "Ця функція недоступна через налаштування шифрування.",
