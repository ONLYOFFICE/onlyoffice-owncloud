OC.L10N.register(
    ...
    "Encryption App is enabled, the application cannot work. You can continue working with the application if you enable master key." : "",
    ...
    "review": "revisió",
    "form filling": "omplir formularis",
    "comment": "comentari",
    ...
    "PDF form": "Formulari PDF",
    "PDF form from existing text file": "Formulari PDF a partir d'un fitxer de text existent",
    "Create form": "Crear formulari",
    "Create new PDF form": "Crea un formulari PDF nou",
    "Security": "Seguretat",
    "Run document macros": "Executar macros de documents",
    "Default editor theme": "Tema de l'editor predeterminat",
    "Light": "Llum",
    "Dark": "Fosc",
    "This feature is unavailable due to encryption settings.": "Aquesta funció no està disponible a causa de la configuració de xifratge",
    ...
    "Easily launch the editors in the cloud without downloading and installation": "Inicieu fàcilment els editors al núvol sense descarregar-los ni instal·lar-los",
    "Get Now": "Obteniu ara",
    ...
    "Could not connect to ONLYOFFICE Docs. See the server log for details." : "No s'ha pogut connectar amb ONLYOFFICE Docs. Consulteu el registre del servidor per obtenir més detalls."
},
