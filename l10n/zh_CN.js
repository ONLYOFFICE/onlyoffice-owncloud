OC.L10N.register(
    ...
    "Encryption App is enabled, the application cannot work. You can continue working with the application if you enable master key." : "加密应用程序已启用，应用程序无法工作。如果启用主密钥，则可以继续使用该应用程序。",
    ...
    "%1\$s mentioned in the %2\$s: \"%3\$s\".": "%1\$s 在 %2\$s: \"%3\$s\"中提到了您.",
    "Choose a format to convert {fileName}": "转换 {fileName} 为选中的格式",
    "PDF form": "PDF 表单",
    "PDF form from existing text file": "用文本文件生成 PDF 表单",
    "Create form": "创建表单",
    ...
    "Create, edit, and co-author documents, sheets, slides, and PDFs within ownCloud using ONLYOFFICE Docs.": "在 ownCloud 中使用 ONLYOFFICE 文档创建、编辑并与他人协作处理文档、表格、演示文稿和 PDF 文件。",
    "Learn more": "了解更多",
