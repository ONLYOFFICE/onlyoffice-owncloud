OC.L10N.register(
    ...
    "PDF form": "PDF-форма",
    "PDF form from existing text file": "PDF-форма из существующего текстового файла",
    ...
    "Create, edit, and co-author documents, sheets, slides, and PDFs within ownCloud using ONLYOFFICE Docs.": "Создавайте, редактируйте текстовые документы, электронные таблицы, презентации и PDF-файлы и работайте над ними совместно в ownCloud с помощью ONLYOFFICE Docs.",
    "Learn more": "Узнать больше",
    "Suggest a feature": "Предложить функцию",
    "To ensure the security of important parameters in ONLYOFFICE Docs requests, please set a Secret Key on the Settings page.": "Для обеспечения безопасности важных параметров в запросах ONLYOFFICE Docs, пожалуйста, установите секретный ключ на странице настроек.",
    "Info": "Информация",
    "%1$s could not be saved. Please open the file again.": "Не удалось сохранить файл %1$s. Откройте файл еще раз.",
    "Could not connect to ONLYOFFICE Docs. See the server log for details.": "Не удалось подключиться к ONLYOFFICE Docs. Подробности см. в журнале сервера."
},
