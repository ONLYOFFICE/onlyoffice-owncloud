...
class AppConfig {
    ...
    */
    ...
    private $formats = [
        ...
        "docx" => [ "mime" => "application/vnd.openxmlformats-officedocument.wordprocessingml.document", "type" => "word", "edit" => true, "def" => true, "review" => true, "fillForms" => true, "comment" => true, "saveas" => ["odt", "pdf", "rtf", "txt"] ],
