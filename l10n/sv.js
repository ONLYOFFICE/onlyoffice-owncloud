OC.L10N.register(
    ...
    "PDF form": "PDF-formulär",
    "PDF form from existing text file": "PDF-formulär från befintlig textfil",
    ...
    "Enable document protection for": "Aktivera dokumentsskydd för",
    "All users": "Alla användare",
    "Owner only": "Endast ägaren",
    "Authorization header (leave blank to use default header)": "Autentiseringshuvud (lämna tom för att använda standardhuvud)",
    ...
    "Could not connect to ONLYOFFICE Docs. See the server log for details." : "Det gick inte att ansluta till ONLYOFFICE Docs. Se serverloggen för mer information."
},
