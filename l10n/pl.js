OC.L10N.register(
    ...
    "Encryption App is enabled, the application cannot work. You can continue working with the application if you enable master key." : "Aplikacja nie działa, ponieważ włączone jest aplikacja Encryption App. Możesz kontynuować pracę z aplikacją, jeśli włączysz klucz master key.",
    ...
    "Allow the following groups to access the editors": "Zezwól następującym grupom na dostęp do edytorów",
    "review": "recenzja",
    ...
    "Easily launch the editors in the cloud without downloading and installation": "Z łatwością uruchamiaj edytory w chmurze bez konieczności pobierania czy instalacji",
    "Get Now": "Wypróbuj teraz",
    ...
    "Could not connect to ONLYOFFICE Docs. See the server log for details.": "Nie można połączyć się z ONLYOFFICE Docs. Szczegóły znajdziesz w dzienniku serwera."
},
